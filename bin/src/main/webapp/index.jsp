		...
		<div id="contaier">
			...
			<div class="col-md-8">
				<img id="poza" class="thumbnail img-responsive"
					src="pics/100x180-acrilic-pe-panza.jpg"
			...
			<div>
				<div class="socialmedia-buttons smw_center col-md-6">
					<a href="https://www.facebook.com/IuliaLaviniaFalcan/"
						...
						src="pics/facebook.png" alt="Facebook" title="Facebook"
						class="scale"></a>
				</div>
				...
				<div class="socialmedia-buttons smw_center col-md-6">
					<a href="https://www.facebook.com/IuliaLaviniaFalcan/"
						rel="nofollow" target="_blank"><img width="32" height="32"
						src="pics/instagram.png" alt="Instagram" title="Instagram"
						class="scale"></a>
				</div>
			...
			<div class="col-xs-6 col-md-4">
				<img id="poza" class="thumbnail img-responsive"
					src="pics/AKDD23C60A_97DC_451F_BBE9_7B329AC4E478_1.jpg"
					alt="100x180-acrilic-pe-panza">
			</div>

			<div class="col-xs-6 col-md-4">
				<img id="poza" class="thumbnail img-responsive"
					src="pics/AKCAD3D685_14B7_4717_8954_788D03ECF574_1.jpg"
					alt="100x180-acrilic-pe-panza">
			</div>

			<div class="col-xs-6 col-md-4">
				<img id="poza" class="thumbnail img-responsive"
					src="pics/AK68D32004_45CE_4434_A605_4920F504931D_1.jpg"
					alt="100x180-acrilic-pe-panza">
			</div>
			<div class="col-xs-6 col-md-4">
				<img id="poza" class="thumbnail img-responsive"
					src="pics/13524401_614321742075481_3453959912641776508_n.jpg"
					alt="100x180-acrilic-pe-panza">
			</div>
			<div class="col-xs-6 col-md-4">
				<img id="poza" class="thumbnail img-responsive"
					src="pics/AK9F708FCE_A01A_406F_B365_E032D869BE86_1.jpg"
					alt="100x180-acrilic-pe-panza">
			</div>
			<div class="col-xs-6 col-md-4">
				<img id="poza" class="thumbnail img-responsive"
					src="pics/AK700D234E_2A42_4138_99B3_5D2B574933A7.jpg"
					alt="100x180-acrilic-pe-panza">
			</div>
